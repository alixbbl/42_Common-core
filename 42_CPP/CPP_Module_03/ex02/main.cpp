...
/*   Updated: 2023/12/22 13:52:45 by alibourb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	ClapTrap	ClapTrap2("Harry");
	ScavTrap	ScavTrap1("Dumbledore");
	FragTrap	FragTrap1("Rogue");
	int			input1;
	int			input2;
	...
	std::cout	<< "Let's fight! Enter Damage points for " << ClapTrap2.get_Name()
				<< " : " << std::endl;
	...
	ClapTrap1.attack(FragTrap1.get_Name()); //  test
	std::cout << std::endl;
